...
void Stylesheet::initializeStylesheet()
{
    ...
    this->stylesheet_digital_0          = QLatin1String(digital_0.readAll());
    this->stylesheet_digital_1          = QLatin1String(digital_1.readAll());
    this->stylesheet_digital_2          = QLatin1String(digital_2.readAll());
    this->stylesheet_digital_3          = QLatin1String(digital_3.readAll());
    this->stylesheet_digital_4          = QLatin1String(digital_4.readAll());
    this->stylesheet_digital_5          = QLatin1String(digital_5.readAll());
    this->stylesheet_digital_6          = QLatin1String(digital_6.readAll());
    this->stylesheet_digital_7          = QLatin1String(digital_7.readAll());
    this->stylesheet_digital_8          = QLatin1String(digital_8.readAll());
    this->stylesheet_digital_9          = QLatin1String(digital_9.readAll());
    smiley.close();
    smiley_won.close();
    smiley_lost.close();
